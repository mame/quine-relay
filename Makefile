...
QR.vb: QR.vim
	@echo
	@echo "#####################################"
	@echo "##  19: Vimscript -> Visual Basic  ##"
	@echo "#####################################"
	@echo
...
QR.ws: QR.vb
	@echo
	@echo "######################################"
	@echo "##  20: Visual Basic -> Whitespace  ##"
	@echo "######################################"
	@echo
	vbnc QR.vb
	mono ./QR.exe > QR.ws
...
QR.lisp: QR.coffee
	@echo
	@echo "#######################################"
	@echo "##  50: CoffeeScript -> Common Lisp  ##"
	@echo "#######################################"
	@echo
...
QR.gbs: QR.f90
	@echo
	@echo "######################################"
	@echo "##  65: Fortran90 -> Gambas script  ##"
	@echo "######################################"
	@echo
...
QR.ppt: QR.ps
	@echo
	@echo "#############################################"
	@echo "##  118: PostScript -> PPT (Punched tape)  ##"
	@echo "#############################################"
	@echo
...
QR.prolog: QR.ppt
	@echo
	@echo "#########################################"
	@echo "##  119: PPT (Punched tape) -> Prolog  ##"
	@echo "#########################################"
	@echo
